...
public class ArrayAdapterSeusConcursos extends ArrayAdapter<Concurso> {

    public ArrayAdapterSeusConcursos(Context context, List<Concurso> forecast){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ArrayAdapterSeusConcursos.ViewHolder viewHolder;
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.publicacoes_alterar_excluir, parent, false);
            viewHolder = new ArrayAdapterSeusConcursos.ViewHolder();
            convertView.setTag(viewHolder);
            setDadosViewHolder(convertView, caraDaVez, viewHolder);
        }
        else{
            viewHolder = (ArrayAdapterSeusConcursos.ViewHolder) convertView.getTag();
    ...
    private void update(ArrayAdapterSeusConcursos.ViewHolder viewHolder, Concurso caraDaVez){
    ...
    private void setDadosViewHolder(@NonNull View convertView, Concurso caraDaVez, ArrayAdapterSeusConcursos.ViewHolder viewHolder) {
